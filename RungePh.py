...
class mclass:
    ...
    def __init__(self, window):
        ...
        labelTitle = Label(window, textvariable=varTitle, bg="green", fg="white", font="bold", height=2)
        ...
        label1 = Label(window, textvariable=var1, bg="orange", font="bold", height=1)
        ...
        label2 = Label(window, textvariable=var2, bg="orange", font="bold", height=1)
        label2.grid(row=2, columnspan=3, sticky=W, padx=20)

        var3 = StringVar()
        var3.set("choisissant les points de division.")
        label3 = Label(window, textvariable=var3, bg="orange", font="bold", height=1)
        label3.grid(row=3, columnspan=3, sticky=W, padx=20)
        varF = StringVar()

        varF.set("La fonction, f(x) :")
        labelF = Label(window, textvariable=varF, bg="yellow", height=2)
        ...
        labelA = Label(window, textvariable=varA, bg="yellow", height=2)
        ...
        labelB = Label(window, textvariable=varB, bg="yellow", height=2)
        ...
        varN = StringVar()
        varN.set("N (Points de division) :")
        labelN = Label(window, textvariable=varN, bg="yellow", height=2)
        ...
        self.button1 = Button(window, text="  PLOT  ", bg="green", fg="white",width=20, command=self.plot)
        self.button1.grid(row=8, column=2, sticky=E, pady=20, padx=20)

        self.button1 = Button(window, text="  Exit  ", bg="green", fg="white",width=20, command=self.exit)
        self.button1.grid(row=8, column=1, sticky=E, pady=20, padx=20)

    def exit(self):
          answer = msg.askyesnocancel("Exit", "Are you sure?")
